...
<head>
  ...
  <title>Arrow ECS - MA</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

 <!-- Favicons -->
 <link href="assets/img/arrow.png" rel="icon">
 <link href="assets/img/arrow.png" rel="apple-touch-icon">
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a class="nav-link scrollto" href="solutions.html"><span>Solutions</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a >Cloud</a></li>
              <li><a>Data Intelligence</a></li>
              <li><a>Edge et IdO</a></li>
              <li><a>NextGen Data Centre</a></li>
              <li><a>Solutions de sécurité</a></li>
            </ul>
          </li>
          <li class="dropdown"><a class="nav-link scrollto" href="services.html"><span>Services</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a>Services de livraison mondiale</a></li>
              <li><a>Arrow Education</a></li>
              <li><a>Hébergement & SaaS</a></li>
              <li><a>Service Marketing</a></li>
              <li><a>Services Techniques</a></li>
            </ul>
          </li>
          <li class="dropdown"><a class="nav-link scrollto" href="fournisseurs.html"><span>Fournisseurs</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a>Dell Technologie</a></li>
              <li><a>Forcepoint</a></li>
              <li><a>IBM</a></li>
              <li><a>Intel</a></li>
              <li><a>Lenovo</a></li>
              <li><a>NUTANIX</a></li>
              <li><a>Red Hat</a></li>
              <li><a>RSA</a></li>
              <li><a>Trend Micro</a></li>
            </ul>
          </li>
          <li class="dropdown"><a class="nav-link scrollto" href="plus.html"><span>Plus</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a>À propos d'Arrow</a></li>
              <li><a>Pourquoi choisir Arrow?</a></li>
              <li><a>Responsabilité sociale d'entreprise (RSE)</a></li>
            </ul>
          </li>
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          ...
          <li><a href="equipe.php">Nous contacter</a></li>
          <li><a href="partenaire.php">Devenir Partenaire</a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="">
                            ...
                            <div class="form-group row">
                                <label for="email_address" class="col-md-4 col-form-label text-md-right">Quels produits et/ ou services offrez-vous ? </label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="email_address" class="col-md-4 col-form-label text-md-right">Comment pouvons-nous vous aider ?  </label>
                                <div class="col-md-6">
                                    <textarea type="text" id="email_address" class="form-control" name="email-address" required autofocus></textarea>
                                </div>
                            </div>
